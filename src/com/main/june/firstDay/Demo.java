package com.main.june.firstDay;

import com.main.utils.DateUtils;

public class Demo {
    public static void main(String[] args) {
//        System.out.println(getUserByName("foxman"));
        User two = new User();
    ...
    public void  setNickeNameByName() {
        User user = new User();
        String dateShortStr = DateUtils.getTodayShort();
        ...
        user.setNickeName(ioo+dateShortStr);
    ...
    public static User getUserByName(String name,String nickName){
        User in= new User();
        in.setName(name);
        return in;
    }
    public static User getUserByNames(String name){
        User in= new User();
        in.setName(name);
        return in;
    }
    ...
    public User createUserByName( String name){
        User isd = new User("s dasadas","sdwads");
        return  isd;
    }
